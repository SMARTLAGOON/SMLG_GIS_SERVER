...
!(function () {
    L.HistoryControl = L.Control.extend({
        ...
        onAdd: function (a) {
            ...
            return (
                this.options.useExternalControls || ((this._backButton = this._createButton("back", b, this.goBack, this)), (this._forwardButton = this._createButton("forward", b, this.goForward, this))),
        ...
        _backButton: null,
        _forwardButton: null,
        _state: { backDisabled: null, forwardDisabled: null, ignoringEvents: !1, maxMovesToSave: 0, history: { items: [] }, future: { items: [] } },
        ...
        _updateDisabled: function () {
            ...
            a !== this._state.backDisabled && ((this._state.backDisabled = a), this._map.fire("historyback" + (a ? "disabled" : "enabled"))),
                b !== this._state.forwardDisabled && ((this._state.forwardDisabled = b), this._map.fire("historyforward" + (b ? "disabled" : "enabled"))),
                this.options.useExternalControls || (this._setButtonDisabled(this._backButton, a), this._setButtonDisabled(this._forwardButton, b));
        },
        ...
        _pop: function (a) {
            return (a = a.items), L.Util.isArray(a) && a.length > 0 ? a.splice(a.length - 1, 1)[0] : void 0;
        },
        _push: function (a, b) {
            var c = this._state.maxMovesToSave;
            (a = a.items), L.Util.isArray(a) && (a.push(b), c > 0 && a.length > c && a.splice(0, 1));
        },
